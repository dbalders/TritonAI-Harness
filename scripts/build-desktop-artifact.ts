...
export class PackagedNativeDependencyMissingError extends Schema.TaggedError<PackagedNativeDependencyMissingError>()(
...
export class PackagedDesktopUpdateConfigMissingError extends Schema.TaggedError<PackagedDesktopUpdateConfigMissingError>()(
...
export class DesktopUpdatePublishConfigurationMissingError extends Schema.TaggedError<DesktopUpdatePublishConfigurationMissingError>()(
...
export class DesktopRuntimeManifestMismatchError extends Schema.TaggedError<DesktopRuntimeManifestMismatchError>()(
...
export class DesktopRuntimeDeploymentArchitectureMissingError extends Schema.TaggedError<DesktopRuntimeDeploymentArchitectureMissingError>()(
...
export class MissingAzureTrustedSigningConfigurationError extends Schema.TaggedError<MissingAzureTrustedSigningConfigurationError>()(
...
export class InvalidAzureTrustedSigningEndpointError extends Schema.TaggedError<InvalidAzureTrustedSigningEndpointError>()(
...
export class ManagedPluginCompositionBuildError extends Schema.TaggedError<ManagedPluginCompositionBuildError>()(
...
/**
 * YAML is used by server settings and stays inlined in the server bundle.
 * Its absence means the bundle went back to externalizing its
 * dependencies, which the sidecar's selected runtime closure does not cover.
 */
const BUNDLE_SELF_CONTAINED_SENTINEL = "yaml";
...
export class ManagedHarnessConfigArtifactError extends Schema.TaggedError<ManagedHarnessConfigArtifactError>()(
...
export class MacDesktopAppBundleMissingError extends Schema.TaggedError<MacDesktopAppBundleMissingError>()(
...
export const DESKTOP_FILE_EXCLUSIONS = [
  // TritonAI Harness always passes the user's installed Claude executable to the SDK,
...
export function resolveMacStageDependencies(input: {
  ...
  return resolveMergedStageDependencies({ ...input, platform: "mac" });
}
...
export class InvalidDesktopStageOnlyOptionsError extends Schema.TaggedError<InvalidDesktopStageOnlyOptionsError>()(
...
export class NightlySourceVersionMismatchError extends Schema.TaggedError<NightlySourceVersionMismatchError>()(
...
export function resolveDesktopProductName(version: string): string {
  return resolveDesktopUpdateChannel(version) === "nightly"
    ? `${TRITONAI_APP_BASE_NAME} (Nightly)`
    : TRITONAI_APP_BASE_NAME;
}
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        ...
        NSScreenCaptureUsageDescription:
          "TritonAI Harness captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  // the build rather than shipping a silent regression.
  {
    ...
    // YAML remains bundled; Effect is deliberately external so managed
    // providers and the host share the same runtime identity.
