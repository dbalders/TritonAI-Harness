  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new TritonAI Harness prerelease is available for nightly testers."
          : "A new TritonAI Harness latest release is available.",
...
).pipe(Command.withDescription("Post a TritonAI Harness release announcement to Discord."));
