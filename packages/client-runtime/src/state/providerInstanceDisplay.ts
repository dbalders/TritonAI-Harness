...
export function resolveProviderInstanceDisplayName(
  ...
  const isLegacyCodexLabel = snapshot.driver === "codex" && trimmedSnapshotName === "Codex";
  if (trimmedSnapshotName && trimmedSnapshotName !== kindLabel && !isLegacyCodexLabel)
  ...
  return isLegacyCodexLabel ? kindLabel : trimmedSnapshotName || kindLabel;
}
