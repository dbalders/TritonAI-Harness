...
const WsServerTranscribeVoiceRpc = Rpc.make(WS_METHODS.serverTranscribeVoice, {
...
const WsServerGetTritonAiUsageRpc = Rpc.make(WS_METHODS.serverGetTritonAiUsage, {
  payload: Schema.Struct({}),
...
const WsServerInstallProviderSkillRpc = Rpc.make(WS_METHODS.serverInstallProviderSkill, {
...
const WsServerRemoveProviderSkillRpc = Rpc.make(WS_METHODS.serverRemoveProviderSkill, {
...
const WsServerSetProviderSkillEnabledRpc = Rpc.make(WS_METHODS.serverSetProviderSkillEnabled, {
...
const WsServerSubmitProviderSkillToTritonAiCommonsRpc = Rpc.make(
...
const WsServerListPluginsRpc = Rpc.make(WS_METHODS.serverListPlugins, {
...
const WsServerInstallPluginRpc = Rpc.make(WS_METHODS.serverInstallPlugin, {
  payload: ServerPluginInstallInput,
  success: ServerPluginsListResult,
  error: Schema.Union([ServerPluginOperationError, EnvironmentAuthorizationError]),
});

const WsServerUninstallPluginRpc = Rpc.make(WS_METHODS.serverUninstallPlugin, {
  payload: ServerPluginUninstallInput,
  success: ServerPluginsListResult,
  error: Schema.Union([ServerPluginOperationError, EnvironmentAuthorizationError]),
});

const WsServerAddMarketplaceRpc = Rpc.make(WS_METHODS.serverAddMarketplace, {
  payload: ServerMarketplaceAddInput,
  success: ServerPluginsListResult,
  error: Schema.Union([ServerPluginOperationError, EnvironmentAuthorizationError]),
});

const WsServerRemoveMarketplaceRpc = Rpc.make(WS_METHODS.serverRemoveMarketplace, {
  payload: ServerMarketplaceRemoveInput,
  success: ServerPluginsListResult,
  error: Schema.Union([ServerPluginOperationError, EnvironmentAuthorizationError]),
});

const WsServerUpgradeMarketplaceRpc = Rpc.make(WS_METHODS.serverUpgradeMarketplace, {
...
const WsIntegrationsListRpc = Rpc.make(WS_METHODS.integrationsList, {
  payload: Schema.Struct({}),
  success: IntegrationsListResult,
  error: IntegrationRpcError,
});
const WsIntegrationsInstallRpc = Rpc.make(WS_METHODS.integrationsInstall, {
  payload: IntegrationIdInput,
  success: IntegrationsListResult,
  error: IntegrationRpcError,
});
const WsIntegrationsSetEnabledRpc = Rpc.make(WS_METHODS.integrationsSetEnabled, {
  payload: IntegrationSetEnabledInput,
  success: IntegrationsListResult,
  error: IntegrationRpcError,
});
const WsIntegrationsSetCapabilityEnabledRpc = Rpc.make(
...
const WsIntegrationsConnectRpc = Rpc.make(WS_METHODS.integrationsConnect, {
  payload: IntegrationConnectInput,
  success: IntegrationConnectResult,
  error: IntegrationRpcError,
});
const WsIntegrationsPollRpc = Rpc.make(WS_METHODS.integrationsPoll, {
  payload: IntegrationPollInput,
  success: IntegrationPollResult,
  error: IntegrationRpcError,
});
const WsIntegrationsDisconnectRpc = Rpc.make(WS_METHODS.integrationsDisconnect, {
  payload: IntegrationIdInput,
  success: IntegrationsListResult,
  error: IntegrationRpcError,
});
...
export const WsSubscribeServerConfigRpc = Rpc.make(WS_METHODS.subscribeServerConfig, {
  payload: Schema.Struct({
    managedPolicyDiagnosticsUpdates: Schema.optionalKey(Schema.Boolean),
    /**
