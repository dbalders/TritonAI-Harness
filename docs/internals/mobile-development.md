...
before opening Xcode, and retain the matching `APP_VARIANT` export in
`ios/.xcode.env.local` for Xcode bundle scripts. Keep separate checkouts for simultaneous production and
