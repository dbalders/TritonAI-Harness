...
a reference, but is not selected by the TritonAI release configuration.
...
Save the two TritonAI exports to:

- `dev/app-icon.icon` -> `dev/tritonai-harness-dev-1024.png`
- `prod/app-icon.icon` -> `prod/tritonai-harness-1024.png`
...
- assets/prod/app-icon.icon -> assets/prod/tritonai-harness-1024.png
