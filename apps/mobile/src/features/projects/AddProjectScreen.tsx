...
function useSelectedEnvironment(environmentIdParam?: string | string[]): {
  ...
  const requestedEnvironmentId = stringParam(environmentIdParam) as EnvironmentId | null;
...
export function AddProjectSourceScreen(props: { readonly environmentId?: string | string[] }) {
  ...
  const { environmentOptions, selectedEnvironment, setSelectedEnvironmentId } =
    useSelectedEnvironment(props.environmentId);
