...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "TritonAI Harness Cloud" section title + refresh button for hosts that
...
/**
 * "TritonAI Harness Cloud" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the TritonAI Harness Cloud
 * onboarding sheet.
 *
