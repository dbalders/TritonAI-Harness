...
function createBrowserLocalApi(): LocalApi {
  return {
    ...
    server: {
      ...
      listProviderSkillCatalog: () => Promise.reject(unavailableLocalBackendError()),
      installProviderSkill: () => Promise.reject(unavailableLocalBackendError()),
      removeProviderSkill: () => Promise.reject(unavailableLocalBackendError()),
      setProviderSkillEnabled: () => Promise.reject(unavailableLocalBackendError()),
      listPlugins: () => Promise.reject(unavailableLocalBackendError()),
      installPlugin: () => Promise.reject(unavailableLocalBackendError()),
      uninstallPlugin: () => Promise.reject(unavailableLocalBackendError()),
