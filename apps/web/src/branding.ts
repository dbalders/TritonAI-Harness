import { TRITONAI_APP_BASE_NAME, type DesktopAppBranding } from "@t3tools/contracts";
...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? TRITONAI_APP_BASE_NAME;
