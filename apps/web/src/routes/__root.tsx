...
import { DesktopNotificationWatcher } from "../components/desktop/DesktopNotificationWatcher";
  ...
  return (
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        {primaryEnvironmentAuthenticated && isElectron ? <DesktopNotificationWatcher /> : null}
