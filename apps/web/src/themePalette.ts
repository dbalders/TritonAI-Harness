...
export const UCSD_THEME_ID = "ucsd" as const;
export const UCSD_THEME_LABEL = "UC San Diego";
...
const LEGACY_THEME_ID_ALIASES: Readonly<Record<string, string>> = {
  ...
  "ucsd-light": UCSD_THEME_ID,
  "ucsd-dark": UCSD_THEME_ID,
};
...
function legacyThemeMode(theme: ThemePreference): ThemeAppearance | null {
  if (theme === LEGACY_T3_CHAT_DARK_THEME_ID || theme === "ucsd-dark") return "dark";
  if (theme === "ucsd-light") return "light";
  return null;
}
...
export const UCSD_THEME: ThemeDefinition = {
  ...
  variants: {
    dark: {
      ...createManagedThemeColors("dark", "#101c30", "#ffcd00"),
