...
export function resolveEnvironmentIdentificationMode(input: {
  ...
  // Avoid briefly rendering the default artwork before a persisted choice loads.
 ...
 * has made one, otherwise the default for this build stage (on for every
 * stage). Every consumer must read through this rather than
