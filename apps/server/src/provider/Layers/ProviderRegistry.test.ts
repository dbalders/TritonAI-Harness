  ...
  (it) => {
    ...
    describe("ProviderRegistryLive", () => {
      ...
      describe("Codex model inventories", () => {
        ...
        it("keeps the managed inventory authoritative during startup and failed probes", () => {
        ...
        it.effect("persists removals across failed refreshes and registry restarts", () =>
          Effect.gen(function* () {
            ...
            const retainedModels = [customModel];

            for (const restarted of [false, true]) {
              yield* Effect.gen(function* () {
                const registry = yield* ProviderRegistry.ProviderRegistry;
                const expectedModels = restarted ? retainedModels : [customModel];
