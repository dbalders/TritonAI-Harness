...
class UnexpectedIntegrationRpcError extends Schema.TaggedError<UnexpectedIntegrationRpcError>()(
      ...
      const dispatchBootstrapThreadCommand = (
        ...
        Effect.gen(function* () {
          ...
          const bootstrapProgram = Effect.gen(function* () {
            ...
            const started = yield* Effect.uninterruptible(dispatchFromClient(finalCommand));
