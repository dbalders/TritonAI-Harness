...
import Migration0033 from "./Migrations/033_BackfillProjectionThreadSessionInstanceId.ts";
...
import Migration0045 from "./Migrations/045_ProjectionThreadGoals.ts";
import Migration0046 from "./Migrations/046_ProjectionThreadGoalRevisionSequence.ts";
...
const migrationEntries = [
  ...
  [33, "BackfillProjectionThreadSessionInstanceId", Migration0033],
  ...
  // colliding upstream migrations in release order so existing
  ...
  [45, "ProjectionThreadGoals", Migration0045],
  [46, "ProjectionThreadGoalRevisionSequence", Migration0046],
  [47, "ClearAutomaticProjectModelDefaults", UpstreamMigration0044],
  [48, "ProjectionProjectsAutoPull", UpstreamMigration0045],
  [49, "RepairAutomaticSettlementTimestamps", UpstreamMigration0046],
  [50, "ProjectionProjectIcon", UpstreamMigration0047],
  [51, "ProjectionThreadBranchPullRequest", UpstreamMigration0048],
  [52, "ProjectionThreadsActiveOrderKey", UpstreamMigration0049],
