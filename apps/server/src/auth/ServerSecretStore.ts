...
export class SecretStoreKeyError extends Schema.TaggedError<SecretStoreKeyError>()(
  "SecretStoreKeyError",
  {
    resource: Schema.String,
...
export class SecretStoreLockTimeoutError extends Schema.TaggedError<SecretStoreLockTimeoutError>()(
