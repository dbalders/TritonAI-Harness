...
export const INSTALLER_UPDATE_STATE_CHANNEL = "desktop:installer-update-state";
export const INSTALLER_UPDATE_GET_STATE_CHANNEL = "desktop:installer-update-get-state";
export const INSTALLER_UPDATE_CHECK_CHANNEL = "desktop:installer-update-check";
export const INSTALLER_UPDATE_OPEN_CHANNEL = "desktop:installer-update-open";
...
export const GET_TRITONAI_CREDENTIAL_STATUS_CHANNEL = "desktop:get-tritonai-credential-status";
export const UPDATE_TRITONAI_CREDENTIALS_CHANNEL = "desktop:update-tritonai-credentials";
...
export const GET_COMPUTER_USE_STATE_CHANNEL = "desktop:get-computer-use-state";
export const SET_COMPUTER_USE_ENABLED_CHANNEL = "desktop:set-computer-use-enabled";
