...
export const OPEN_NOTIFICATION_SETTINGS_CHANNEL = "desktop:open-notification-settings";
...
export const REPLACE_TRITONAI_API_KEY_CHANNEL = "desktop:replace-tritonai-api-key";
